...
impl WindowHandler for MyWindowHandler {
	fn on_draw(&mut self, helper: &mut WindowHelper, graphics: &mut Graphics2D) {
		...
		graphics.draw_line( (0.0,y1), (self.largura_total as f32,y1), 4.0, Color::BLACK);
		graphics.draw_line( (0.0,y2), (self.largura_total as f32,y2), 4.0, Color::BLACK);
		...
		graphics.draw_line( (zero_h,0.0), (zero_h,self.altura_total as f32), 4.0, Color::BLACK);
...
fn laco_simulacao( simul: &mut Simulacao) -> bool {
	...
	println!("#main: tempo_ateh_proxima_chegada {}", simul.tempo_ateh_proxima_chegada);
